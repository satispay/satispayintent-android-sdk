...
- Option 1: Import from gradle (recommended) - Not yet available
- Option 2: You can copy this class in your project: [https://github.com/satispay/satispayintent-android-sdk/blob/master/satispayintent/src/main/java/com/satispay/satispayintent/SatispayIntent.java](https://github.com/satispay/satispayintent-android-sdk/blob/master/satispayintent/src/main/java/com/satispay/satispayintent/SatispayIntent.java)
...
##### Example - How to use inside an Activity
```
public class MyActivity extends AppCompatActivity {
    //
    // ...
...
TODO: Add link to server docs "how to obtain charge token"
...
3. Get token from your backend.
4. Obtain `payToken()` Intent.
```
SatispayIntent.payToken(@NonNull String scheme, @NonNull String appId, @NonNull String token)
```
...
public class MyActivity extends AppCompatActivity {
    ...
    public String obtainToken() {
        ...
        // NOTE: You should persist the token, app may be killed from the system.
...
2. Build `openAppIntent` using follow URI:
```
satispay:
```
3. Call `startActivity()` using the Intent
...
3. Get token from your backend.
4. Build `payTokenIntent` using follow URI:
```
satispay://external/generic/charge?token=[MyToken]
```
5. Call `startActivityForResult()` using the Intent, you should define a constant requestCode parameter.
